...
/**
 * Freedom_Demo_Importer Class.
 */
class Freedom_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'freedom' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'freedom' ), __( 'Demo Importer', 'freedom' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
