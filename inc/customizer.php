 ...
 * @since freedom 1.1.4
 */
function freedom_customize_preview_js() {
   wp_enqueue_script( 'freedom-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), false, true );
}
add_action( 'customize_preview_init', 'freedom_customize_preview_js' );
