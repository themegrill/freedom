...
<?php
	...
	if( !empty( $freedom_custom_css ) && ! function_exists( 'wp_update_custom_css_post' ) ) {
 ...
 */
function freedom_customm_css_migrate() {
	if ( get_option( 'freedom_custom_css_transfer' ) ) {
		return;
	}
	$theme_custom_css = get_theme_mod( 'freedom_custom_css', '' );
